...
const getGameBotVersionsByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const versionId of bot.versions) {
        const version = yield version_model_1.default.findOne({ _id: versionId });
        botVersions.push(version);
    }
    res.status(200).json({ versions: botVersions });
});
exports.default = getGameBotVersionsByUserId;
